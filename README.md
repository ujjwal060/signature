...
``` bash
# dev server with hot reload at http://13.200.240.28:3000
$ npm start 
```
...
Navigate to [http://13.200.240.28:3000](http://13.200.240.28:3000). The app will automatically reload if you change any of the source files.
